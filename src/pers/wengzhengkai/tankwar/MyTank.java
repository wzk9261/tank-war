...
public class MyTank extends Picture implements Movable, Hitable, Destroyable, Blockable {
	...
	public MyTank(int x, int y, boolean isWeng) {
	...
	public MyBullet shot() {
		...
		MyBullet bullet = new MyBullet(this);
