...
public class MyBullet extends Picture implements Attackable, Destroyable, Hitable {
	
	private Direction direction;
	private final int speed = 8;
	
	public MyBullet(MyTank myTank) {
	...
	public boolean checkHit(Hitable h) {
		// TODO Auto-generated method stub
		if (h instanceof MyTank || h instanceof MyBullet) {
			return false;
		}
		Picture p = (Picture) h;
